...
const images = ["/pro-1-1.png", "/pro-1-2.png", "/pro-1-3.png", "/pro-1-4.png"];

const SmProductDetail = () => {
  ...
  return (
    <>
      <div className={smStyle.smProductDetailmain}>
        <div className="container">
          <div className={style.smProductDeatilInnerItems}>
