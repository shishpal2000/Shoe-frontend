                ...
                <div className="container">
                    <div className={style.header_items}>
                        ...
                        <div className={style.contact}>
                            <div className={style.icon}>
                                <figure><img src="WhatsApp_black.svg" alt="call icon" /></figure>
                            </div>
                            <div className={style.detail}>
                                <a href="tel:821730182123"> <span>Call US :</span> (+62) 821730182123</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className={style.menuBar_items}>
                        <ul className={style.menuLink}>
                            ...
                            <li><a href="">shoes <img src="arrow-down.svg" alt="" /></a></li>
                        ...
                        <ul className={style.menuOpt}>
                            <li>
                                <a href="">
                                    <figure><img src="user.svg" alt="" /></figure>
                                </a>
                            </li>
                            <li>
                            <a href="">
                                    <figure><img src="cart.svg" alt="" /></figure>
                                </a>
                            </li>
                        </ul>
                    </div>
